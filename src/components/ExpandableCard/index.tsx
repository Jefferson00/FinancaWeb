...
const ExpandableCard = observer(({ card, invoice }: ExpandableCardProps) => {
      ...
      <section>
        ...
        <main>
          <div>
            <p>Fatura atual</p>
            <strong>
              {getCurrencyFormat(invoice.value)}
            </strong>
          </div>
          <div>
            <p>Pago:</p>
        ...
        <footer>
          ...
          <div>
            ...
            <p>
              {getDayOfTheMounth(card.pay_date)}
            </p>
          </div>
        </footer>
      </section>
